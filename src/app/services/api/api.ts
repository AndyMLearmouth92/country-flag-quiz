...
export class Api {
  ...
  getCountryData(chosenRegion: string) {
    const baseUrl = `https://api.restcountries.com/countries/v5?limit=100&response_fields=names,flag,continents,landlocked,population,languages,capitals,currencies,borders,subregion,tlds&pretty`;
